...
//
//	mockgen -source=article.go -package=svcmocks -destination=svcmocks/article.mock.go ArticleService
//
...
import (
	...
	domain "example.com/mod/webook/internal/domain"
...
func (m *MockArticleService) GetById(ctx context.Context, uid, id int64) (domain.Article, error) {
	m.ctrl.T.Helper()
...
func (mr *MockArticleServiceMockRecorder) GetById(ctx, uid, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetById", reflect.TypeOf((*MockArticleService)(nil).GetById), ctx, uid, id)
}

// GetPublishedById mocks base method.
func (m *MockArticleService) GetPublishedById(ctx context.Context, uid, id int64) (domain.Article, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPublishedById", ctx, uid, id)
	ret0, _ := ret[0].(domain.Article)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockArticleServiceMockRecorder) GetPublishedById(ctx, uid, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPublishedById", reflect.TypeOf((*MockArticleService)(nil).GetPublishedById), ctx, uid, id)
}
